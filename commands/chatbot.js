    ...
    try {
        ...
        if (!response) {
            await sock.sendMessage(chatId, { 
                text: "Hmm, laisse moi y réfléchir... 🤔\nJ'ai des difficultés à traiter ta demande pour le moment.",
                quoted: message
            });
            return;
        }
        ...
        try {
            await sock.sendMessage(chatId, { 
                text: "Oops! 😅 J'ai été un peu confus. Pourrais tu reformuler ta question ??",
                quoted: message
            });
        } catch (sendError) {
