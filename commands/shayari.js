...
async function shayariCommand(sock, chatId, message) {
    try {
        ...
        const buttons = [
            { buttonId: '.shayari', buttonText: { displayText: 'Poeme 📃' }, type: 1 },
            { buttonId: '.roseday', buttonText: { displayText: '🌹 Jour de Rose' }, type: 1 }
        ];
        ...
        await sock.sendMessage(chatId, { 
            text: '❌ Impossible de récupérer un texte pour le moment. Veuillez réessayer plus tard.',
        }, { quoted: message });
    }
}
